...
alias cp='cp -v'
alias d='cd /media/DOWNLOADS/Downloads ; clear'
...
alias h='cd /DATAS/kandarec/ ; clear'
...
alias jNET='jnettop -x "not tcp" -i $(ifconfig | grep -B1 "inet"|grep -i ether|cut -f1 -d" ")'
...
alias Kitploit='python /DATAS/ProgPython/kitploit.py |grep -v href |grep -v "/a" |grep -v "]"' 
...
alias CAnAl+="cd /DLs/Downs/canal && youtube-dl http://www.canalplus.fr/c-emissions/c-le-petit-journal/pid6515-le-petit-journal.html"
