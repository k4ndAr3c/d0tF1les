...
function lsbTestAll { for i in mersenne log_gen identity fibonacci fermat eratosthenes composite triangular_numbers carmichael ackermann ackermann_naive Dead_Man_Walking syracuse ; do stegano-lsb-set reveal -i $1 -g $i ; done ; }
