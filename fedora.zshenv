...
alias a='dnf'
alias a2='systemctl start httpd'
alias a2s='systemctl stop httpd'
alias aI='dnf install'
alias adg='dnf distro-sync'
...
alias chromium-browser='chromium --user-data-dir=/root/.chromium-browser'
alias cl='clear ; ls -hFl'
alias cp='cp -v'
alias d='cd /root/Downloads ; clear'
...
function MakePlayList { touch ./"$2" && find "$1" -print | egrep -ie '(*.mp3|*.wav|*.m4a|*.wma|*.ogg|*.mp4|*.mpc)'  >> "$2" ; echo ---DONE!--- ; }
...
alias NT='arp-scan -l -I $(ifconfig | grep flags|grep -v lo|cut -f1 -d":")'
alias jNET='jnettop -i $(ifconfig | grep flags|grep -v lo|cut -f1 -d":")'
#PdfDim=gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=
alias FR="gtrans.py -d fr"
alias US="gtrans.py -d us"
#alias S='echo "$?"'
alias bugtraq='sshXKey 10.42.1.27'
alias n3th='sshXKey 10.42.1.28'
...
alias Kitploit='python /H/F1L3s/ProgPython/kitploit.py |grep -v href |grep -v "/a" |grep -v "]"' 
function scpKEY { scp -i /root/KEY $1 $2 ; }
...
alias CAnAl+='youtube-dl "http://www.canalplus.fr/c-divertissement/c-le-petit-journal/pid6515-le-petit-journal.html"'
...
alias uniscan="cd /H/F1L3s/GITs/uniscan ; ./uniscan.pl"
alias -g H='--help'
